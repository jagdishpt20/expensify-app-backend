package com.jss.expensifyappbackend.utility;
...
public class Utils {
	...
	/*
	 * public String generateAddressId(int length) { return
	 * generateRandomString(length); } public static boolean hasTokenExpired(String
	 * token) { boolean returnValue = false;
	 * 
	 * try { Claims claims =
	 ...
	 * SecurityConstants.getTokenSecret()).compact(); return token; }
	 * 
